...
export const Route = createFileRoute("/explore/pathway-advisor")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "UniLink Pathway Advisor — Discover your future" },
      {
      ...
      { property: "og:url", content: "/explore/pathway-advisor" },
    ],
    links: [{ rel: "canonical", href: "/explore/pathway-advisor" }],
  }),
  component: PathwayAdvisorPage,
});

function PathwayAdvisorPage() {
  return (
    <>
