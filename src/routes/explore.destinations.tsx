...
export const Route = createFileRoute("/explore/destinations")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Destination Explorer" },
      {
        property: "og:description",
        content: "Compare study destinations on the criteria that actually affect your experience.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:url", content: "/explore/destinations" },
    ],
    links: [{ rel: "canonical", href: "/explore/destinations" }],
  }),
  component: DestinationExplorerPage,
});

function DestinationExplorerPage() {
  return (
    <>
