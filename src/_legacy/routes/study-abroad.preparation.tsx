...
export const Route = createFileRoute("/study-abroad/preparation")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Preparation & Requirements" },
      {
        property: "og:description",
        content: "Documents, language, finances and practical preparation for international study.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:url", content: "/study-abroad/preparation" },
    ],
    links: [{ rel: "canonical", href: "/study-abroad/preparation" }],
  }),
