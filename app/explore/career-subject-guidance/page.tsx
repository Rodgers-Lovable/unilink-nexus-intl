...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "/explore/career-subject-guidance",
  },
  twitter: {
    card: "summary_large_image",
  },
  alternates: {
    canonical: "/explore/career-subject-guidance",
  },
};

export default function CareerSubjectGuidancePage() {
  return (
    <>
      <Breadcrumbs
        items={[{ label: "Explore", to: "/explore" }, { label: "Career & Subject Guidance" }]}
      />
      <PageHero
        image="explore"
      ...
      >
        ...
        <Button asChild variant="outline" size="lg">
          <Link href="/services/career-guidance">Career Guidance Service</Link>
        </Button>
      </PageHero>
